...
# 모델 경로(문자열로 변환하여 사용) 
plate_model_path = str(Path("C:/Users/USER/Documents/GitHub/four-people/FastAPI/models/plate_ocr.pt"))
assist_model_path = str(Path("C:/Users/USER/Documents/GitHub/four-people/FastAPI/models/assist_device.pt"))
